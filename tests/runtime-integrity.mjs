...
assert.match(html, /\.\/vendor\/pdf\/packlist-pdf-adapter\.js\?v=1\.10\.26/, 'PDF export must load the local Packlist PDF adapter');
assert.match(html, /\.\/vendor\/pdf\/packlist-autotable-adapter\.js\?v=1\.10\.26/, 'PDF export must load the local Packlist AutoTable adapter');
...
assert.match(sw, /\/vendor\/pdf\/packlist-pdf-adapter\.js\?v=1\.10\.26/, 'service worker must precache the local Packlist PDF adapter');
assert.match(sw, /\/vendor\/pdf\/packlist-autotable-adapter\.js\?v=1\.10\.26/, 'service worker must precache the local Packlist AutoTable adapter');
